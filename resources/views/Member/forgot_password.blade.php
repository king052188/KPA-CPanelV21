...
<div class="login-box">
    <div class="logo" style="background: #4267b2; padding: 10px;">
        <a href="javascript:void(0);"><b>CPanelV21</b> - Reset Password</a>
        <small>Version 21.0.0 - {{ date("Y") }}</small>
    </div>
    <div class="card">
        <div class="body">
            <form method="POST" action="/forgot-password/processing">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-4">
                        ...
                        <button id="btnSignUp" class="btn btn-block bg-blue waves-effect" type="submit">RESET</button>
                    </div>
                </div>
            </form>
