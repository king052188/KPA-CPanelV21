$(document).ready(function() {
    ...
    $("#btnWebAppWordPress").click(function (e) {
        e.preventDefault();
        var host =  $("#host").val();
        ...
        var data = { hostname: host };
        
        var d = ajax_execute(data, "/api/web/app/install", "btnWebAppWordPress", null);
    })
    ...
    $("#btnYesDumpFile").click(function(e) {

        e.preventDefault();

        hostname = $('#ddlHostnameLists').val();

        var data = { hostname: hostname, database: d_name };

        var d = ajax_execute(data, "/api/mysql/dump/exec", "btnYesDumpFile", "dump");
    })
