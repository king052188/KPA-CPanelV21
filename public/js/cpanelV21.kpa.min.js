$(document).ready(function() {
    ...
    $("#btnPackagePlan").click(function (e) {
        e.preventDefault();
        var package_plan =  $("#package").val();

        if(parseInt(package_plan) == 0) {
            message_box("Warning!", "Please choose one of our packages", "warning");
            return false;
        }

        var data = { package_plan: package_plan };
        var d = ajax_execute(data, "/api/package/plan/create", "btnPackagePlan", "/dashboard");
    })
