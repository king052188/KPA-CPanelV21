$(document).ready(function() {
    ...
    $("#btnSaveDatabase").click(function (e) {
        ...
        var data = {database: database, account: account};
        var d = ajax_execute(data, "/mysql/create-database-execute");
        $("#database").val("");
    ...
    $("#btnSaveAccount").click(function (e) {
        ...
        var d = ajax_execute(data, "/mysql/create-database-username-execute");
        $("#username").val("");
        $("#password1").val("");
        $("#password2").val("");
